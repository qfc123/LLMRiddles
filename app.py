...
_LLM = os.environ.get('QUESTION_LLM', 'baidu')
assert _LLM in ['chatgpt', 'mistral-7b', 'baidu', 'chatglm'], _LLM
...
if _LANG == "cn":
    ...
    title_markdown = """
    <h2 style="text-align: center; color: black;"> 🎭LLM Riddles：完蛋！我被 LLM 拿捏了</a></h2>
    <strong><h5 align="center"> 更多不同语言模型的在线试玩 demo 可以访问 GitHub<a href="https://github.com/qfc123/LLMRiddles/">源代码仓库</a>获取<h5></strong>
    <h5 align="center"> 如果你喜欢这个项目，请给我们在 GitHub 点个 star ✨ <a href="https://github.com/qfc123/LLMRiddles/"> 代码仓库传送门 </a> 。我们将会持续保持更新。再次感谢游戏<a href="https://www.zhihu.com/people/haoqiang-fan"> 原作者 </a>的奇思妙想！  </h5>
    ...
    如果您的游玩体验有不佳之处，我们将删除相关信息，并不断改进这个项目。
    ...
    title_markdown = """
    <h2 style="text-align: center; color: black;"><a href="https://github.com/qfc123/LLMRiddles/"> 🎭LLM Riddles: Oops! Rolling in LLM.</a></h2>
    <h5 align="center"> If you like our project, please give us a star ✨ on GitHub for latest update <a href="https://github.com/qfc123/LLMRiddles/"> (Code Link) </a>. Thanks for the interesting idea of the original game <a href="https://www.zhihu.com/people/haoqiang-fan"> author </a>.  </h5>
    ...
    We will delete those and keep improving our moderator.
...
if __name__ == '__main__':
    ...
    demo.queue().launch(server_name = "0.0.0.0",server_port=7860, max_threads=concurrency, favicon_path=favicon_path)
